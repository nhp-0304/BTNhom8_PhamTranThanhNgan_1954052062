...
driver.find_element(By.LINK_TEXT, 'Điện tử & Điện thoại').click()
driver.find_element(By.LINK_TEXT, 'Phụ kiện điện thoại').click()
driver.find_element(By.LINK_TEXT, 'Tai nghe/Phụ kiện tai nghe').click()
