...
driver.find_element(By.LINK_TEXT, 'Đồ gia dụng').click()
driver.find_element(By.LINK_TEXT, 'Dụng cụ nhà bếp').click()
driver.find_element(By.LINK_TEXT, 'Dụng cụ nhà bếp khác').click()
