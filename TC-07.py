...
driver.find_element(By.ID, "username").send_keys("kakimanh123")
driver.find_element(By.ID, "fullName").click()
driver.find_element(By.ID, "fullName").send_keys("Ka kim ánh")
driver.find_element(By.ID, "mobile").send_keys("0918533530")
...
driver.find_element(By.ID, "birthday").send_keys("2001-02-12")
...
driver.find_element(By.ID, "rePassword").send_keys("anh987")

try:
    driver.find_element(By.NAME, 'rePassword').clear()
