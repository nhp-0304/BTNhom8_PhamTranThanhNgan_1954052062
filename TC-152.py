...
driver.find_element(By.LINK_TEXT, 'Phụ kiện').click()
driver.find_element(By.LINK_TEXT, 'Trang sức').click()
driver.find_element(By.LINK_TEXT, 'Dây chuyền/vòng cổ').click()
