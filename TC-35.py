...
driver.find_element(By.ID, "customerMobile").clear()
driver.find_element(By.ID, "customerMobile").click()
driver.find_element(By.ID, "customerMobile").send_keys("11234yu")
time.sleep(3)
